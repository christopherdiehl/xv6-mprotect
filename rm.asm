...
printint(int fd, int xx, int base, int sgn)
{
 ...
 452:	0f b6 80 0c 0b 00 00 	movzbl 0xb0c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 58e:	75 25                	jne    5b5 <printf+0xff>
          s = "(null)";
 590:	c7 45 f4 99 08 00 00 	movl   $0x899,-0xc(%ebp)
        while(*s != 0){
...
morecore(uint nu)
{
 ...
 77f:	83 c4 10             	add    $0x10,%esp
  return freep;
 782:	a1 28 0b 00 00       	mov    0xb28,%eax
}
 787:	c9                   	leave  
 788:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 79b:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 79e:	a1 28 0b 00 00       	mov    0xb28,%eax
 7a3:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7a6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7aa:	75 23                	jne    7cf <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7ac:	c7 45 f0 20 0b 00 00 	movl   $0xb20,-0x10(%ebp)
 7b3:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b6:	a3 28 0b 00 00       	mov    %eax,0xb28
 7bb:	a1 28 0b 00 00       	mov    0xb28,%eax
 7c0:	a3 20 0b 00 00       	mov    %eax,0xb20
    base.s.size = 0;
 7c5:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 7cc:	00 00 00 
  }
 ...
 822:	a3 28 0b 00 00       	mov    %eax,0xb28
      return (void*)(p + 1);
 ...
 82d:	eb 3b                	jmp    86a <malloc+0xe1>
    ...
    if(p == freep)
 82f:	a1 28 0b 00 00       	mov    0xb28,%eax
