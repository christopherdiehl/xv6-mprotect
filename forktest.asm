...
gets(char *buf, int max)
{
 ...
 233:	50                   	push   %eax
 234:	6a 00                	push   $0x0
 236:	e8 77 01 00 00       	call   3b2 <read>
...
stat(char *n, struct stat *st)
{
 ...
 299:	e8 3c 01 00 00       	call   3da <open>
...
int signal(int signum, void(*handler)(int))
{
 ...
 372:	68 62 03 00 00       	push   $0x362
 377:	e8 ce 00 00 00       	call   44a <signal_restorer>
 ...
 388:	e8 b5 00 00 00       	call   442 <signal_register>
