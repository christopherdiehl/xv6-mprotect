...
bigargtest(void)
{
  ...
  if(pid == 0){
    ...
    378f:	c7 04 85 40 63 00 00 	movl   $0x5a48,0x6340(,%eax,4)
    3796:	48 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    3fcf:	e8 4b ff ff ff       	call   3f1f <write>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    402a:	0f b6 80 28 63 00 00 	movzbl 0x6328(%eax),%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    422e:	a1 c8 63 00 00       	mov    0x63c8,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    42f9:	a3 c8 63 00 00       	mov    %eax,0x63c8
}
    42fe:	90                   	nop
    42ff:	c9                   	leave  
    4300:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    4320:	50                   	push   %eax
    4321:	e8 61 fc ff ff       	call   3f87 <sbrk>
  ...
  return freep;
    435a:	a1 c8 63 00 00       	mov    0x63c8,%eax
}
    435f:	c9                   	leave  
    4360:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    4376:	a1 c8 63 00 00       	mov    0x63c8,%eax
    437b:	89 45 f0             	mov    %eax,-0x10(%ebp)
    437e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4382:	75 23                	jne    43a7 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    4384:	c7 45 f0 c0 63 00 00 	movl   $0x63c0,-0x10(%ebp)
    438b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    438e:	a3 c8 63 00 00       	mov    %eax,0x63c8
    4393:	a1 c8 63 00 00       	mov    0x63c8,%eax
    4398:	a3 c0 63 00 00       	mov    %eax,0x63c0
    base.s.size = 0;
    439d:	c7 05 c4 63 00 00 00 	movl   $0x0,0x63c4
    43a4:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    43fa:	a3 c8 63 00 00       	mov    %eax,0x63c8
      return (void*)(p + 1);
    ...
    if(p == freep)
    4407:	a1 c8 63 00 00       	mov    0x63c8,%eax
