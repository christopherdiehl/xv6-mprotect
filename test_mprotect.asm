...
void handler(int signum, siginfo_t info)
{
   ...
   c:	50                   	push   %eax
   d:	68 c4 08 00 00       	push   $0x8c4
  12:	6a 01                	push   $0x1
  14:	e8 f5 04 00 00       	call   50e <printf>
  ...
  27:	68 ec 08 00 00       	push   $0x8ec
  2c:	6a 01                	push   $0x1
  2e:	e8 db 04 00 00       	call   50e <printf>
  ...
  3e:	6a 04                	push   $0x4
  40:	50                   	push   %eax
  41:	e8 e9 03 00 00       	call   42f <mprotect>
  ...
  4e:	6a ff                	push   $0xffffffff
  50:	6a 07                	push   $0x7
  52:	6a fd                	push   $0xfffffffd
  54:	68 24 09 00 00       	push   $0x924
  59:	6a 01                	push   $0x1
  5b:	e8 ae 04 00 00       	call   50e <printf>
  60:	83 c4 20             	add    $0x20,%esp
		printf(1, "ERROR: Didn't get proper exception, this should not happen.\n");
  63:	83 ec 08             	sub    $0x8,%esp
  66:	68 58 09 00 00       	push   $0x958
  6b:	6a 01                	push   $0x1
  6d:	e8 9c 04 00 00       	call   50e <printf>
  72:	83 c4 10             	add    $0x10,%esp
		exit();
  75:	e8 fd 02 00 00       	call   377 <exit>
	}
}
  7a:	c9                   	leave  
  7b:	c3                   	ret    
...
int main(void)
{
  ...
  95:	6a 02                	push   $0x2
  97:	e8 aa 02 00 00       	call   346 <signal>
  9c:	83 c4 10             	add    $0x10,%esp
 	p = (int *) sbrk(1);
  9f:	83 ec 0c             	sub    $0xc,%esp
  a2:	6a 01                	push   $0x1
  a4:	e8 56 03 00 00       	call   3ff <sbrk>
  a9:	83 c4 10             	add    $0x10,%esp
  ac:	a3 70 0c 00 00       	mov    %eax,0xc70
 	mprotect((void *)p, sizeof(int), PROT_READ);
  b1:	a1 70 0c 00 00       	mov    0xc70,%eax
  b6:	83 ec 04             	sub    $0x4,%esp
  b9:	6a fd                	push   $0xfffffffd
  bb:	6a 04                	push   $0x4
  bd:	50                   	push   %eax
  be:	e8 6c 03 00 00       	call   42f <mprotect>
  c3:	83 c4 10             	add    $0x10,%esp
 	*p=100;
  c6:	a1 70 0c 00 00       	mov    0xc70,%eax
  cb:	c7 00 64 00 00 00    	movl   $0x64,(%eax)
 	printf(1, "COMPLETED: value is %d, expecting 100!\n", *p);
  d1:	a1 70 0c 00 00       	mov    0xc70,%eax
  d6:	8b 00                	mov    (%eax),%eax
  d8:	83 ec 04             	sub    $0x4,%esp
  db:	50                   	push   %eax
  dc:	68 98 09 00 00       	push   $0x998
  e1:	6a 01                	push   $0x1
  e3:	e8 26 04 00 00       	call   50e <printf>
  e8:	83 c4 10             	add    $0x10,%esp

 	exit();
  eb:	e8 87 02 00 00       	call   377 <exit>
...
gets(char *buf, int max)
{
 ...
 210:	50                   	push   %eax
 211:	6a 00                	push   $0x0
 213:	e8 77 01 00 00       	call   38f <read>
...
stat(char *n, struct stat *st)
{
 ...
 276:	e8 3c 01 00 00       	call   3b7 <open>
...
int signal(int signum, void(*handler)(int,siginfo_t))
{
 ...
 34f:	68 3f 03 00 00       	push   $0x33f
 354:	e8 ce 00 00 00       	call   427 <signal_restorer>
 ...
 365:	e8 b5 00 00 00       	call   41f <signal_register>
...
putc(int fd, char c)
{
 ...
 44f:	e8 43 ff ff ff       	call   397 <write>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4aa:	0f b6 80 50 0c 00 00 	movzbl 0xc50(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5e6:	75 25                	jne    60d <printf+0xff>
          s = "(null)";
 5e8:	c7 45 f4 c0 09 00 00 	movl   $0x9c0,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6ae:	a1 6c 0c 00 00       	mov    0xc6c,%eax
...
free(void *ap)
{
 ...
 779:	a3 6c 0c 00 00       	mov    %eax,0xc6c
}
 77e:	90                   	nop
 77f:	c9                   	leave  
 780:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7a0:	50                   	push   %eax
 7a1:	e8 59 fc ff ff       	call   3ff <sbrk>
 ...
 7d7:	83 c4 10             	add    $0x10,%esp
  return freep;
 7da:	a1 6c 0c 00 00       	mov    0xc6c,%eax
}
 7df:	c9                   	leave  
 7e0:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7f3:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7f6:	a1 6c 0c 00 00       	mov    0xc6c,%eax
 7fb:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7fe:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 802:	75 23                	jne    827 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 804:	c7 45 f0 64 0c 00 00 	movl   $0xc64,-0x10(%ebp)
 80b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 80e:	a3 6c 0c 00 00       	mov    %eax,0xc6c
 813:	a1 6c 0c 00 00       	mov    0xc6c,%eax
 818:	a3 64 0c 00 00       	mov    %eax,0xc64
    base.s.size = 0;
 81d:	c7 05 68 0c 00 00 00 	movl   $0x0,0xc68
 824:	00 00 00 
  }
 ...
 87a:	a3 6c 0c 00 00       	mov    %eax,0xc6c
      return (void*)(p + 1);
 ...
 885:	eb 3b                	jmp    8c2 <malloc+0xe1>
    ...
    if(p == freep)
 887:	a1 6c 0c 00 00       	mov    0xc6c,%eax
