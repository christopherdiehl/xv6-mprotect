...
printint(int fd, int xx, int base, int sgn)
{
 ...
 442:	0f b6 80 04 0b 00 00 	movzbl 0xb04(%eax),%eax
...
free(void *ap)
{
 ...
 646:	a1 20 0b 00 00       	mov    0xb20,%eax
...
free(void *ap)
{
 ...
 711:	a3 20 0b 00 00       	mov    %eax,0xb20
}
 716:	90                   	nop
 717:	c9                   	leave  
 718:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 76f:	83 c4 10             	add    $0x10,%esp
  return freep;
 772:	a1 20 0b 00 00       	mov    0xb20,%eax
}
 777:	c9                   	leave  
 778:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 812:	a3 20 0b 00 00       	mov    %eax,0xb20
      return (void*)(p + 1);
 ...
 81d:	eb 3b                	jmp    85a <malloc+0xe1>
    ...
    if(p == freep)
 81f:	a1 20 0b 00 00       	mov    0xb20,%eax
