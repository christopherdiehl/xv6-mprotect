...
printint(int fd, int xx, int base, int sgn)
{
 ...
 44a:	0f b6 80 0c 0b 00 00 	movzbl 0xb0c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 586:	75 25                	jne    5ad <printf+0xff>
          s = "(null)";
 588:	c7 45 f4 97 08 00 00 	movl   $0x897,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 64e:	a1 28 0b 00 00       	mov    0xb28,%eax
...
free(void *ap)
{
 ...
 719:	a3 28 0b 00 00       	mov    %eax,0xb28
}
 71e:	90                   	nop
 71f:	c9                   	leave  
 720:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 777:	83 c4 10             	add    $0x10,%esp
  return freep;
 77a:	a1 28 0b 00 00       	mov    0xb28,%eax
}
 77f:	c9                   	leave  
 780:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 793:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 796:	a1 28 0b 00 00       	mov    0xb28,%eax
 79b:	89 45 f0             	mov    %eax,-0x10(%ebp)
 79e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7a2:	75 23                	jne    7c7 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7a4:	c7 45 f0 20 0b 00 00 	movl   $0xb20,-0x10(%ebp)
 7ab:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7ae:	a3 28 0b 00 00       	mov    %eax,0xb28
 7b3:	a1 28 0b 00 00       	mov    0xb28,%eax
 7b8:	a3 20 0b 00 00       	mov    %eax,0xb20
    base.s.size = 0;
 7bd:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 7c4:	00 00 00 
  }
 ...
 81a:	a3 28 0b 00 00       	mov    %eax,0xb28
      return (void*)(p + 1);
 ...
 825:	eb 3b                	jmp    862 <malloc+0xe1>
    ...
    if(p == freep)
 827:	a1 28 0b 00 00       	mov    0xb28,%eax
